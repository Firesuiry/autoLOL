...
def get_charter(self:Any,pic:np.array) -> int:
    ...
    try:
        ...
        ll = self.ai.useModel(self, "Moeny.h5", ret).tolist()
        p = ""
        for i in ll:
            p += i
        return int(p)
...
if __name__ == '__main__':
    model = tf.keras.models.load_model(r'C:\Users\Administrator\Desktop\autoLOL\model\Money.h5')
    test_images = get_charter("C:\\Users\\Administrator\\Desktop\\ans\\MONEY13.png")
